...
import { FieldError, Form, Input, Label, TextField, Description } from '@heroui/react';
                                ...
                                <Form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <label className="text-gray-600 text-sm">
                                            I agree to the{" "}
                                            <a href="#" className="text-green-500 hover:text-teal-600 font-semibold">Terms of Service</a>
                                            {" "}and{" "}
                                            <a href="#" className="text-teal-500 hover:text-green-600 font-semibold">Privacy Policy</a>
                                        </label>
                                    </div>
                                    ...
                                    <p className="text-center text-gray-600 text-sm">
                                        ...
                                        <Link href="/login" className="text-teal-500 hover:text-green-600 font-semibold">Login</Link>
                                    </p>
                                </Form>
