...
const LoginPage = () => {
    ...
    const handleSubmit = async(e) => {
      ...
      if(!error){
        toast.success('you have login account succefully!')
        setLoading(false);
        redirect('/')
      }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10 lg:pt-12 pb-10 sm:pb-16 lg:pb-20 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
      ...
      <div className="relative flex justify-center items-center w-full">
        ...
        <div className="relative w-full flex justify-center">
          ...
          {/* Floating squiggles */}
          <div className="absolute -left-4 sm:-left-8 lg:-left-12 top-6 sm:top-10 lg:top-12 text-3xl sm:text-5xl lg:text-6xl text-amber-400 opacity-30 pointer-events-none">
            ~
          </div>

          <div className="absolute right-2 sm:right-6 lg:right-8 bottom-6 sm:bottom-10 lg:bottom-12 text-3xl sm:text-4xl lg:text-5xl rotate-12 opacity-40 pointer-events-none">
            ~
          </div>
